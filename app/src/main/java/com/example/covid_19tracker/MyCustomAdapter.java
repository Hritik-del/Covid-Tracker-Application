...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // Now , for setting the image of the flag form the url we will use glide library. It sets the image from url to imageView.
    ...
    // MOst important function which does the work of search
    // Need to search on documentation on getFilter method
    @NonNull
    @Override
